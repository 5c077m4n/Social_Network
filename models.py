...
class User(UserMixin, Model):
    ...
    def followers(self):
        """The users that I am being followed by.
        """
        return (
            User.select().join(
...
class Post(Model):
    ...
    #     related_name = 'posts'
    # )
    user = ForeignKeyField(User, 'posts')
    content = TextField()
...
class Relationship(Model):
    from_user = ForeignKeyField(User, 'relationships')
    to_user = ForeignKeyField(User, 'realted_to')
